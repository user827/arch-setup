...
package() {
  ...
  mkdir -m755 "$pkgdir"/srv "$pkgdir"/srv/myhttp "$pkgdir"/srv/myhttp/sensord
  chown 33:33 "$pkgdir"/srv/myhttp/sensord
  install -m644 http/* "$pkgdir"/srv/myhttp/
}
